      ...
      <div class="row">
        ...
        <div class="col-sm-11"><h2><font color="#fff">Daftar</font></h2></div>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<input type="text" name="user_anggota" placeholder="Username" class="form-control"><br>
					<input type="password" name="pass_anggota" placeholder="Password" class="form-control"><br>
					<input type="text" name="nama_anggota" placeholder="Nama" class="form-control"><br>
          <input type="text" name="ttl_anggota" placeholder="Tanggal Lahir" onfocus="(this.type='date')" class="form-control"><br>
          <textarea name="bio_anggota" placeholder="Bio" style="height:100px;" class="form-control"></textarea><br>
